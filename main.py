...
products = []  # Оголосити список перед використанням


# Функція для додавання товарів до списку
def add_product():
    ...
    while True:
        try:
            ...
            break  # Вийти з циклу, якщо введено коректне число
        except ValueError:
...
while True:
    ...
    choice = input("Оберіть режим (1/2/3): ")
    ...
    if choice == '1':
        ...
        print("Дякуємо за використання Касового апарату. До побачення!")
        break
    else:
        print("Невірний вибір. Будь ласка, введіть 1, 2 або 3.")
